...
def for_test(x_t):
    ...
    attn_decoder1.load_state_dict(torch.load('attn_decoder_lr0.00001_GN_te1_d05_SGD_bs6_mask_conv_bn_b_xavier.pkl', map_location=torch.device('cpu')))
    attn_decoder1=attn_decoder1.module
